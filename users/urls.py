...
urlpatterns = [
    ...
    path('users/<uuid:pk>/', UserViewset.as_view({'put': 'update'}), name='update-user'),
    path('users/<uuid:pk>/', UserViewset.as_view({'patch': 'partial_update'}), name='update-user-partially'),
    path('users/<uuid:pk>/', UserViewset.as_view({'delete': 'destroy'}), name='delete-user'),
